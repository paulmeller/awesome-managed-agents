...
- [Claude Managed Agents: The Complete Developer Guide (2026)](https://aiworkflows.tools/blog/claude-managed-agents-complete-guide-2026) - Architecture deep-dive with full Python and TypeScript quickstart code, pricing calculator with worked examples, honest vendor lock-in assessment, and a decision matrix comparing Managed Agents against the Agent SDK.
- [The Fourth Way to Build AI Agents With Claude](https://cobusgreyling.medium.com/claude-managed-agents-0f47df3caa6f) - Analysis by the Chief AI Evangelist at Kore.ai framing Managed Agents as the fourth Claude agent paradigm alongside the Agent SDK, Markdown Definitions, and Agent Teams, with working four-step code examples.
- [Claude Managed Agents: Anthropic's New Agent Platform and What It Means for SMEs](https://medium.com/@ai_93276/claude-managed-agents-anthropics-new-agent-platform-and-what-it-means-for-smes-57586acfaa97) - Analysis from an AI consultancy perspective covering the build-versus-buy decision, infrastructure economics compared to self-managed Cloud Run deployments, and the most relevant use cases for small and medium businesses.
- [Claude Managed Agents in 2026: The Complete Developer's Guide](https://www.eesel.ai/blog/claude-managed-agents) - Developer guide covering the decoupled brain-from-hands architecture, time-to-first-token performance improvements, built-in tooling, research preview features, and a comparison of Managed Agents against DIY agent frameworks.
...
- [stainlu/openclaw-managed-agents](https://github.com/stainlu/openclaw-managed-agents) - Open-source, multi-model self-hostable implementation of the Agent/Environment/Session/Event API shape, built on OpenClaw with 175 passing tests, per-session quotas, audit log, and one-command deploy scripts for Hetzner, AWS Lightsail, and GCP.
...
- [Claude Code's NEW Managed Agents Just Changed EVERYTHING](https://www.youtube.com/watch?v=SSPy3cCSLuc) - Real-world SaaS deployment walkthrough showing Managed Agents inside Harbor Build, covering credential vaults, the eight built-in tools, custom tool integration, and a live demo building an AI website builder with Astro and Stripe.
- [Claude Managed Agents: Deploy AI Agents That Run for Hours](https://www.youtube.com/watch?v=DpfLbBuhHOg) - Tutorial building a complete Next.js application on Managed Agents, covering all four core primitives, the Console UI, CLI, and SDK with a live agent deployment demo including environment configuration and event streaming.
